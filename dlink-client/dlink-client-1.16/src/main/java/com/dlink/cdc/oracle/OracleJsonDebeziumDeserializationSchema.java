...
/**
 * @version 1.0
 * @className: com.dlink.cdc.mysql.OracleJsonDebeziumDeserializationSchema
 * @Description: oracle cdc source
 * @craeteDate 2023-08-27
 * @author: tuzw
 */
public class OracleJsonDebeziumDeserializationSchema implements DebeziumDeserializationSchema<String> {
    ...
    public OracleJsonDebeziumDeserializationSchema() {
        this(false);
    }

    public OracleJsonDebeziumDeserializationSchema(Boolean includeSchema) {
        this.includeSchema = includeSchema;
    }

    public OracleJsonDebeziumDeserializationSchema(Boolean includeSchema, Map<String, Object> customConverterConfigs) {
        this.includeSchema = includeSchema;
